...
class mod_dialogue_renderer extends plugin_renderer_base {
     ...
     * @return string
     */
    public function render_dialogue_conversation(\mod_dialogue\conversation $conversation) {
    ...
    public function show_button_group() {
        ...
        if ($show == \mod_dialogue\dialogue::SHOW_MINE) {
            $showurl->param('show', \mod_dialogue\dialogue::SHOW_EVERYONE);
        ...
        if ($show == \mod_dialogue\dialogue::SHOW_EVERYONE) {
            $showurl->param('show', \mod_dialogue\dialogue::SHOW_MINE);
